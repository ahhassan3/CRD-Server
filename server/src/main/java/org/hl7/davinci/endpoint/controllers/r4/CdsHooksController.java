...
public class CdsHooksController {
   ...
   */
  @CrossOrigin
  @PostMapping(value = FHIR_RELEASE + URL_BASE + "/GetPriorAuthRequirement",
      consumes = "application/json;charset=UTF-8")
  public CoverageRequirements GetPriorAuthRequirement(@RequestBody OrderSignRequest request, final HttpServletRequest httpServletRequest) {
    logger.info("r4/GetPriorAuthRequirement");
    if (request.getPrefetch() == null) {
      request.setPrefetch(new CrdPrefetch());
    }
